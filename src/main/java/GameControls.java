...
//    private Map<Session, Long> lastResponse;
//
//
//    public GameControls() {
//        this.rooms = new LinkedList<>();
//        this.lobby = new Lobby();
//        this.lastResponse = new ConcurrentHashMap<>();
...
//            ));
//            lastResponse.put(user, new Date().getTime());
//        } else {
//            user.getRemote().sendString(String.valueOf(
//                    new JSONObject()
//                            .put("action", "newUser")
...
//
//    public void pong(Session user) throws IOException, JSONException {
//        this.lastResponse.put(user, new Date().getTime());
//    }
//
...
//    }
//
//    private void ping() throws JSONException, IOException {
//        notifyAllUsers(new JSONObject().put("action", "ping"));
//    }
//
//    private void checkConnections() throws IOException, JSONException {
//        for (Session user : this.lastResponse.keySet()) {
//            if (new Date().getTime() - lastResponse.get(user) >= 2 * 1000) {
//                abortGame(user);
//                this.lastResponse.remove(user);
//                lobby.removeUser(user);
//                rooms.forEach((room -> room.removeUser(user)));
